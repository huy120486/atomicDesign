...
import { ScrollBar } from '../../react-velonic';

const ScrollBarComponent = () => (
  <ScrollBar style={{ margin: '50px', width: '500px', height: '300px' }}>
    <p>
      One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed
      in his bed into a horrible vermin. He lay on his armour-like back, and if he lifted his head
      a little he could see his brown belly, slightly domed and divided by arches into
      stiff sections. The bedding was hardly able to cover it and seemed ready to slide off
      any moment. His many legs, pitifully thin compared with the size of the rest of him, waved
      about helplessly as he looked. {'"What\'s happened to me?"'} he thought. It {"wasn't"} a dream.
      His room, a proper human room although a little too small, lay peacefully between its
      ...
      fitted out with a fur hat and fur boa who sat upright, raising a heavy fur muff that covered
      the whole of her lower arm towards the viewer. Gregor then turned to look out the window at
      the dull weather. Drops
    </p>
    <p>
      ...
      Bright vixens jump; dozy fowl quack. Quick wafting zephyrs vex bold Jim. Quick zephyrs blow,
      ...
      A wizard’s job is to vex chumps quickly in fog. Watch {'"Jeopardy!"'}, Alex {"Trebek's"} fun TV
      quiz game. Woven silk pyjamas exchanged for blue quartz. Brawny gods just
    </p>
  </ScrollBar>
);
